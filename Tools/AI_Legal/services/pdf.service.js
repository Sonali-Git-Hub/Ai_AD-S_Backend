 ...
 */
export const generatePrecedentPDF = async (precedentData, language = 'English') => {
    const isHindi = language === 'Hindi' || language === 'hi';
    
    const strings = {
        section1: isHindi ? "खंड 1: मामले के तथ्य" : "SECTION 1: Case Facts",
        section2: isHindi ? "खंड 2: मुख्य कानूनी मुद्दा" : "SECTION 2: Core Legal Issue",
        section3: isHindi ? "खंड 3: निर्णय का तर्क" : "SECTION 3: Judgment Reasoning & Ratio Decidendi",
        section4: isHindi ? "खंड 4: कानूनी आधार" : "SECTION 4: Legal Basis (Acts / Sections Applied)",
        section5: isHindi ? "खंड 5: अंतिम निर्णय" : "SECTION 5: Final Verdict",
        section6: isHindi ? "खंड 6: मुख्य बातें" : "SECTION 6: Key Takeaways",
        footer: isHindi ? "AISA AI लीगल टूलकिट द्वारा निर्मित" : "Generated by AISA AI Legal Toolkit"
    };
    let browser;
    try {
        const {
        ...
        const htmlContent = `
            ...
            <body>
                ...
                <div class="section">
                    <div class="section-title">${strings.section1}</div>
                ...
                <div class="section">
                    <div class="section-title">${strings.section2}</div>
                ...
                <div class="section">
                    <div class="section-title">${strings.section3}</div>
                    <div class="content">
                ...
                <div class="section">
                    <div class="section-title">${strings.section4}</div>
                    <div class="content">
                ...
                <div class="section">
                    <div class="section-title">${strings.section5}</div>
                ...
                <div class="section">
                    <div class="section-title">${strings.section6}</div>
                    <div class="content">
                        <ul class="bullet-list">
