const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/OverviewTab-BlRYQ-pk.js","assets/index-DjJL8ne1.js","assets/index-aY25SibZ.css","assets/chart-pie-5enm9Zpo.js","assets/UsersTab-B2G-DIxl.js","assets/ban-h264KDyq.js","assets/PlansTab-UL-YVwqG.js","assets/ToolLimitTab-ZKToCUoG.js","assets/SettingsTab-Bh_cCFhv.js","assets/LegalPagesTab-D6YPC8Gc.js","assets/KnowledgeBaseTab-BstqsYgu.js","assets/ChatSessionsTab-BpH0HsyS.js","assets/AnalyticsTab-L2ptJTzp.js","assets/laptop-CgF-hEBA.js","assets/cpu-Q1laqy5N.js","assets/trending-down-Cg3HSTl7.js","assets/AdminHelpDesk-CyfiqVy0.js","assets/FinanceTab-fHVrsAry.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, m as motion, v as useLanguage, r as reactExports, w as useNavigate, q as getUserData, x as ChartColumn, y as Users, M as MessageSquare, B as CreditCard, H as TrendingUp, l as Shield, F as FileText, I as Headphones, J as BookOpen, S as Settings, K as logo, N as ArrowLeft, A as AnimatePresence, O as React, _ as __vitePreload } from "./index-DjJL8ne1.js";
...
const OverviewTab = React.lazy(() => __vitePreload(() => import("./OverviewTab-BlRYQ-pk.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const UsersTab = React.lazy(() => __vitePreload(() => import("./UsersTab-B2G-DIxl.js"), true ? __vite__mapDeps([4,1,2,5,3]) : void 0));
const PlansTab = React.lazy(() => __vitePreload(() => import("./PlansTab-UL-YVwqG.js"), true ? __vite__mapDeps([6,1,2,3]) : void 0));
const ToolLimitTab = React.lazy(() => __vitePreload(() => import("./ToolLimitTab-ZKToCUoG.js"), true ? __vite__mapDeps([7,1,2,3]) : void 0));
const SettingsTab = React.lazy(() => __vitePreload(() => import("./SettingsTab-Bh_cCFhv.js"), true ? __vite__mapDeps([8,1,2,3]) : void 0));
const LegalPagesTab = React.lazy(() => __vitePreload(() => import("./LegalPagesTab-D6YPC8Gc.js"), true ? __vite__mapDeps([9,1,2,3]) : void 0));
const KnowledgeBaseTab = React.lazy(() => __vitePreload(() => import("./KnowledgeBaseTab-BstqsYgu.js"), true ? __vite__mapDeps([10,1,2,3]) : void 0));
const ChatSessionsTab = React.lazy(() => __vitePreload(() => import("./ChatSessionsTab-BpH0HsyS.js"), true ? __vite__mapDeps([11,1,2,5]) : void 0));
const AnalyticsTab = React.lazy(() => __vitePreload(() => import("./AnalyticsTab-L2ptJTzp.js"), true ? __vite__mapDeps([12,1,2,13,14,3,15]) : void 0));
const AdminHelpDesk = React.lazy(() => __vitePreload(() => import("./AdminHelpDesk-CyfiqVy0.js"), true ? __vite__mapDeps([16,1,2]) : void 0));
const FinanceTab = React.lazy(() => __vitePreload(() => import("./FinanceTab-fHVrsAry.js"), true ? __vite__mapDeps([17,1,2]) : void 0));
