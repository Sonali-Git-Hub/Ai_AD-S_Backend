var _a;
import { a0 as useIsDark, r as reactExports, a1 as useMotionValue, z as zt, j as jsxRuntimeExports, A as AnimatePresence, m as motion, a2 as WandSparkles, b$ as History, N as ArrowLeft, X, ad as LoaderCircle, cJ as Video, bX as Download, U as Upload, a8 as axios, ac as ChevronDown, P as Check } from "./index-DjJL8ne1.js";
import CustomVideoPlayer from "./CustomVideoPlayer-De8k59FO.js";
import { u as useMotionTemplate, P as PromptLibraryModal } from "./PromptLibraryModal-B16MSOGI.js";
import { R as RotateCw } from "./rotate-cw-C4ifNIEm.js";
import "./maximize-DF4iAG2F.js";
const baseURL = ((_a = window._env_) == null ? void 0 : _a.VITE_AISA_BACKEND_API) || "http://127.0.0.1:8080/api";
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (((_c = (_b = error.response) == null ? void 0 : _b.data) == null ? void 0 : _c.error) === "Insufficient credits") {
        zt.error("Usage limit reached. Please upgrade your plan.");
      } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { children: [
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[1200] flex items-center justify-center p-2 sm:p-4 bg-slate-950/40 dark:bg-black/60 backdrop-blur-[6px] sm:backdrop-blur-[8px] overflow-y-auto lg:!left-[280px] modal-open-indicator", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full max-w-3xl my-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 z-0 rounded-[32px] ${isDark ? "bg-zinc-950" : "bg-white"}` }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 rounded-[32px] border ${isDark ? "border-white/10" : "border-slate-100"} z-[3] pointer-events-none` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative z-[8] px-3 sm:px-6 py-3 sm:py-5 border-b border-slate-100 dark:border-zinc-800 flex items-center justify-between shrink-0 ${isDark ? "bg-zinc-900" : "bg-slate-50"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-10 w-[200px] h-full bg-gradient-to-l from-white/10 to-transparent pointer-events-none blur-xl" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3.5 relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[8px] sm:text-[9px] text-slate-500 font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em]", children: showHistory ? "Previously generated videos" : "Google Vertex AI Veo ⚡ Cinematic Video Synthesis" })
              ] })
            ] }),
          ...
          showHistory ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-6 py-6 custom-scrollbar relative z-[8]", children: isLoadingHistory ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center h-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-8 h-8 animate-spin text-primary" }) }) : historyVideos.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4", children: historyVideos.map((video) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/60 rounded-xl overflow-hidden border border-white/70 shadow-sm flex flex-col group", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[320px] sm:max-w-[360px] mx-auto w-full flex flex-col gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-black text-slate-700 dark:text-slate-300 uppercase tracking-[0.25em] self-start ml-1", children: resultVideoUrl ? "Video Result" : "Source Image" }),
              resultVideoUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full aspect-square bg-black rounded-[20px] overflow-hidden border border-slate-200 dark:border-zinc-800 shadow-sm flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomVideoPlayer, { src: resultVideoUrl, compact: true }) }) : previewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group w-full aspect-square bg-slate-50 dark:bg-zinc-950 rounded-[20px] overflow-hidden border border-slate-200 dark:border-zinc-800 shadow-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: previewUrl,
                ...
                isGenerating ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center bg-black/40 backdrop-blur-[2px] text-white p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-8 h-8 animate-spin text-white mb-2" }),
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-12 h-12 rounded-full ${isDragging ? "bg-primary/20" : "bg-white dark:bg-zinc-900"} flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm border border-slate-200 dark:border-zinc-800`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: `w-6 h-6 ${isDragging ? "text-primary" : "text-slate-500"}` }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center px-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-slate-700 dark:text-slate-200", children: isDragging ? "Drop Image Here" : "Click or Drag Image" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1 text-slate-400 dark:text-slate-500", children: "First frame of the video" })
                    ] })
                  ]
                }
              )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:flex sm:flex-wrap gap-2 sm:gap-3 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 w-full sm:w-auto flex-1 text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full bg-slate-500 dark:bg-slate-400 shadow-[0_0_6px_rgba(0,0,0,0.1)]" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[9px] font-black uppercase tracking-[0.25em] text-slate-700 dark:text-slate-300", children: "Quality Core" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CustomSelect,
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 w-full sm:w-auto flex-1 text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full bg-slate-500 dark:bg-slate-400 shadow-[0_0_6px_rgba(0,0,0,0.1)]" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[9px] font-black uppercase tracking-[0.25em] text-slate-700 dark:text-slate-300", children: "Resolution" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CustomSelect,
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 w-full sm:w-auto flex-1 text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full bg-slate-500 dark:bg-slate-400 shadow-[0_0_6px_rgba(0,0,0,0.1)]" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[9px] font-black uppercase tracking-[0.25em] text-slate-700 dark:text-slate-300", children: "Video Ratio" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CustomSelect,
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ml-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 rounded-full bg-slate-500 dark:bg-slate-400 shadow-[0_0_6px_rgba(0,0,0,0.1)]" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[9px] font-black uppercase tracking-[0.25em] text-slate-700 dark:text-slate-300", children: "Animation Prompt" })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-slate-400 dark:text-slate-500 ml-1", children: 'Be descriptive. Use phrases like "swaying gently", "camera pans left", "zooms in slowly".' })
            ] })
          ] }),
          !showHistory && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 sm:px-6 py-3 sm:py-4 border-t border-slate-100 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-900 flex flex-row items-center justify-between gap-2 shrink-0 relative z-[8]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: handleReset,
