...
import { C as ChartPie } from "./chart-pie-5enm9Zpo.js";
import { T as TrendingDown } from "./trending-down-Cg3HSTl7.js";
/**
          ...
          children: detailLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-5 custom-scrollbar", children: [
              drawerTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
                ...
                selectedIncidentDetail.affectedUsersDetails && selectedIncidentDetail.affectedUsersDetails.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-[10px] font-black text-subtext uppercase tracking-widest", children: [
                    "Affected Users (",
                    selectedIncidentDetail.affectedUsersDetails.length,
                    ")"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: selectedIncidentDetail.affectedUsersDetails.map((user, idx) => {
                    var _a2, _b2;
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 p-2.5 bg-white/5 border border-white/5 rounded-xl", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden border border-white/10 shrink-0", children: user.avatar ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: user.avatar, alt: user.name, className: "w-full h-full object-cover", onError: (e) => {
                        e.currentTarget.onerror = null;
                        e.currentTarget.src = "/account.png";
                      } }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-primary text-[10px]", children: ((_b2 = (_a2 = user.name) == null ? void 0 : _a2.charAt(0)) == null ? void 0 : _b2.toUpperCase()) || "U" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-maintext text-xs truncate leading-tight", children: user.name }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-subtext truncate mt-0.5", children: user.email })
                      ] })
                    ] }, idx);
                  }) })
                ] }),
                occurrences && occurrences.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black text-subtext uppercase tracking-widest", children: "Recent Event Occurrences" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-[220px] overflow-y-auto custom-scrollbar border border-white/5 rounded-xl p-2.5 bg-white/[0.01]", children: occurrences.map((occ, idx) => {
                    var _a2;
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 bg-white/5 border border-white/5 rounded-xl space-y-1.5 text-xs", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center flex-wrap gap-1 text-[10px] text-subtext/60", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5.5 h-5.5 rounded-full bg-white/10 flex items-center justify-center overflow-hidden border border-white/10 shrink-0", children: ((_a2 = occ.userInfo) == null ? void 0 : _a2.avatar) ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: occ.userInfo.avatar, alt: "U", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-3 h-3 text-subtext/80" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 flex-1", children: occ.userInfo ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-maintext truncate leading-none", children: [
                          occ.userInfo.name,
                          " ",
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-normal text-subtext", children: [
                            "(",
                            occ.userInfo.email,
                            ")"
                          ] })
                        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-subtext/70 italic leading-none", children: "Anonymous / Guest User" }) })
                      ] }),
                      occ.sessionId && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[9px] font-mono text-subtext/40 truncate", children: [
                        "Session ID: ",
                        occ.sessionId
                      ] })
                    ] }, occ._id || idx);
              ...
              drawerTab === "replay" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 h-full", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: replayLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-20 gap-2", children: [
                  ...
                  replayData.userInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 p-3 bg-primary/10 border border-primary/20 rounded-xl", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-primary/20 flex items-center justify-center overflow-hidden border border-primary/30 shrink-0", children: replayData.userInfo.avatar ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: replayData.userInfo.avatar, alt: "U", className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-4 h-4 text-primary" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-maintext text-xs leading-none", children: replayData.userInfo.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-subtext leading-none mt-1.5", children: replayData.userInfo.email })
                    ] })
                  ] }),
