import { r as reactExports, ca as useActiveCase, bS as useOutputLanguage, z as zt, a as apiService, c8 as generateChatResponse, j as jsxRuntimeExports, bU as ChevronLeft, b$ as History, bJ as Landmark, bM as Gavel, cb as Brain, cx as Building2, t as Scale, F as FileText, l as Shield, cy as Library, ae as Search, c2 as Star, bV as LanguageToggle, cz as CopyOutputButton, b_ as Share2, cm as Mic, X, c3 as Folder } from "./index-DjJL8ne1.js";
...
const LegalResearch = ({ currentCase, onBack, theme, allProjects = [], onUpdateCase }) => {
  ...
  reactExports.useEffect(() => {
    if (triggerAutoRun && currentCase && !isAuditing) {
      zt.success("✓ Case loaded for Legal Research", { icon: "📚", duration: 3e3 });
      setTimeout(() => {
        const query = `Landmark precedents for: ${currentCase.name}. facts: ${currentCase.description || ""}`;
