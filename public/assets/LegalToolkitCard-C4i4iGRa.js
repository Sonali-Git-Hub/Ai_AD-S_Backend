import { bI as FolderKanban, bJ as Landmark, bK as NotebookPen, bL as ScanText, bM as Gavel, bN as Target, bO as FileCheck, bP as Waypoints, J as BookOpen, v as useLanguage, r as reactExports, a9 as reactDomExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion, t as Scale, k as Sparkles, aa as Minimize2, ab as Maximize2, X, bQ as MessageCircle, Z as Zap, z as zt } from "./index-DjJL8ne1.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2.5 sm:gap-4 relative z-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-4 h-4 sm:w-5 sm:h-5", strokeWidth: 1.8 })
                }
              ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "font-bold text-slate-900 dark:text-white group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition-colors tracking-tight text-[12px] sm:text-[14px]", children: tool.name }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 dark:text-slate-400 text-[9px] sm:text-[11px] leading-relaxed font-medium line-clamp-2", children: tool.desc })
          ] }),
          !isUnlocked
        ] })
      ]
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 sm:gap-3.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { size: 20, strokeWidth: 1.8, className: "text-white" })
                          }
                        ) }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5", children: toolsList.map((tool, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToolCard, { tool, index: idx, onClose, onSelect, t: tLegal }, tool.id)) }),
