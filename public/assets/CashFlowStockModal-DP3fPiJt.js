var _a;
import { r as reactExports, a7 as lookup, a8 as axios, a9 as reactDomExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion, H as TrendingUp, aa as Minimize2, ab as Maximize2, X, ac as ChevronDown, P as Check, ad as LoaderCircle, ae as Search, C as CircleAlert, s as Lock, af as Activity, k as Sparkles, E as ExternalLink, x as ChartColumn, ag as ResponsiveContainer, ah as Tooltip, Z as Zap, J as BookOpen, e as ChevronRight, l as Shield, G as Globe, ai as Markdown, a as apiService, O as React } from "./index-DjJL8ne1.js";
import { L as LockOpen } from "./lock-open-rzH4nvbP.js";
import { M as Maximize } from "./maximize-DF4iAG2F.js";
import { A as AreaChart, X as XAxis, Y as YAxis, a as Area } from "./AreaChart-CdN8HhAe.js";
  ...
  reactExports.useEffect(() => {
    ...
    if (activeTab === "Realtime chart") {
      ...
      axios.get(`${baseURL}/stock/intraday`, { params, headers }).then((res) => {
        ...
        var _a4, _b3, _c3, _d3;
        setIsLoadingTab(false);
        const errMsg = ((_b3 = (_a4 = err.response) == null ? void 0 : _a4.data) == null ? void 0 : _b3.error) || ((_d3 = (_c3 = err.response) == null ? void 0 : _c3.data) == null ? void 0 : _d3.message) || `Failed to load intraday data.`;
        setTabError(errMsg);
      });
      if (socket) {
        socket.emit("subscribe_realtime", { symbol: selectedStock.symbol });
      ...
      if (promise) {
        promise.then((result) => {
          ...
          var _a4, _b3, _c3, _d3;
          const errMsg = ((_b3 = (_a4 = err.response) == null ? void 0 : _a4.data) == null ? void 0 : _b3.error) || ((_d3 = (_c3 = err.response) == null ? void 0 : _c3.data) == null ? void 0 : _d3.message) || `Failed to load ${activeTab}.`;
          setTabError(errMsg);
